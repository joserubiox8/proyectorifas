  ...
  return (
    <main className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 flex flex-col items-center justify-center">
      <div className="max-w-md w-full bg-white rounded-3xl shadow-xl overflow-hidden flex flex-col gap-4 bg-transparent shadow-none pb-8">
        ...
        <div id="receipt-card" className="bg-white rounded-3xl overflow-hidden shadow-xl border border-gray-100 relative">
          {order.status === 'APPROVED' ? (
            <div className="bg-green-500 p-6 pt-8 text-center flex flex-col items-center">
              <img src="/logo.png" alt="Logo" className="h-16 w-auto object-contain mb-4" crossOrigin="anonymous" />
              <h1 className="text-2xl font-black text-white mb-2">¡Compra Confirmada!</h1>
              <p className="text-green-100 text-sm">Tus números ya están asegurados. ¡Mucha suerte!</p>
            </div>
          ) : (
          ...
          <div className="p-6 pb-2">
            <div className="mb-6 bg-gray-50 rounded-xl p-4 border border-gray-100">
              ...
              <div className="flex justify-between pt-2 border-t border-gray-200 mt-2">
                ...
                <span className="font-black text-xl">{order.totalAmount.toLocaleString('es-CO')}</span>
              </div>
            </div>
