      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Selecciona tus números de la suerte. Con cada número principal, te llevas <span className="font-bold text-black">10 números adicionales de 3 cifras</span>. ¡No te quedes sin jugar!
          </p>
        </div>
