...
export default function Footer() {
  ...
  const waLink = `https://wa.me/${adminWhatsApp}?text=Hola,%20tengo%20una%20duda%20sobre%20la%20rifa`;

  return (
    <footer className="mt-12 pb-8 text-center text-sm text-gray-500">
      <div className="flex flex-col items-center justify-center gap-2">
        <p><strong>Rifas JR</strong> &mdash; &copy; {new Date().getFullYear()} Todos los derechos reservados.</p>
        <a 
          href={waLink} 
          target="_blank" 
